...
const uint8_t pin_ph_relay = 11; ///< ph control relay pin
...
const uint8_t pin_enable_ec_automation = 14; ///< enable/disable automation input pin
const uint8_t pin_enable_ph_automation = 17; ///< enable/disable automation input pin
